		<ul class="menu">
			...
			foreach ($categorias as $categoria) { ?>
				<li class="menu--item<?php if (isset($categoria_id) && $categoria['id'] == $categoria_id) {
											echo ' menu--item--selecionado';
										} ?>"><a class="menu--link" href="/categorias.php?cod=<?= $categoria['id'] ?>" title="<?= $categoria['titulo'] ?>"><?= $categoria['titulo'] ?></a></li>
			<?php } ?>
		</ul>